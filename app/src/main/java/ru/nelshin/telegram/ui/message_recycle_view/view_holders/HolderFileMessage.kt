...
import ru.nelshin.telegram.database.getFileFromStorage
import ru.nelshin.telegram.ui.message_recycle_view.views.MessageView
import ru.nelshin.telegram.utilits.WRITE_FILES
...
class HolderFileMessage(view: View) : RecyclerView.ViewHolder(view), MessageHolder {
    ...
    private val blockReceivedFileMessage: ConstraintLayout =
        view.findViewById(R.id.bloc_recived_file_message)
    ...
    private val chatReceivedFileMessageTime: TextView =
        view.findViewById(R.id.chat_recived_file_message_time)
